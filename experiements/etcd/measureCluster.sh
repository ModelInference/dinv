...
runlim -o a.time etcd --name infra0 --initial-advertise-peer-urls http://$LOCAL:2380 \
...
runlim -o b.time etcd --name infra1 --initial-advertise-peer-urls http://$L1:2380 \
...
runlim -o c.time etcd --name infra2 --initial-advertise-peer-urls http://$L2:2380 \
